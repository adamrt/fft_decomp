...
typedef struct world_menu_entry {
    ...
    s16 _unknown_10[2]; /* 0x10: cleared with the size fields (open_menu_start_music_test_list_thread) */
    ...
    u8 _padding_2e[2];           /* aligns text_binding */
