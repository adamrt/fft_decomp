...
extern u8 g_debugchr_editor_numeric_geometry[];
extern status_panel_numeric_buffer_t g_debugchr_editor_numeric_state_a[2];
extern status_panel_numeric_buffer_t g_debugchr_editor_numeric_state_b[2];
...
extern status_panel_editor_state_t g_debugchr_panel_comparison_billboard;
...
extern status_panel_editor_state_t g_debugchr_panel_selected_billboard;
...
extern status_panel_indicator_prims_t g_debugchr_thread_indicator_packets[2][2];
...
extern u8 g_debugchr_panel_item_icon_texture[];
...
extern u8 g_debugchr_panel_origin_offsets[];
extern status_panel_offset_pair_t g_debugchr_character_status_frame_rect[];
...
extern status_panel_buffer_t g_debugchr_panel_frames_a[];
...
void debugchr_gfx_build_scaled_draw_area_packets(status_panel_portrait_primitive_tail_t* packet, const void* source,
    s32 scale_index, s32 lower_half, const s16* offset);
void debugchr_gfx_build_status_group_primitives(POLY_FT4* poly);
void debugchr_gfx_init_menu_tile_and_line_primitives(status_panel_menu_primitives_t* menu);
void debugchr_gfx_init_scaled_draw_area_packets(status_panel_portrait_primitive_tail_t* packet);
...
void debugchr_text_render_decimal_entry_list(
    s32 pixels, status_panel_gauge_entry_t* entries, status_panel_text_position_t* output, s32 count);
void debugchr_text_render_decimal_value(s32 value, s32 flags, void* pixels, status_panel_text_position_t* position);
void debugchr_text_render_signed_decimal_entries(
    s32 pixels, status_panel_gauge_entry_t* entries, status_panel_text_position_t* output, s32 count);
...
extern status_panel_numeric_entry_t g_debugchr_panel_comparison_numeric_entries[];
extern CVECTOR g_debugchr_panel_gauge_bar_colors[];
extern status_panel_numeric_entry_t g_debugchr_panel_selected_numeric_entries[];
extern const debug_chr_texture_page_t g_debugchr_panel_status_texture;
extern status_panel_glyph_t g_debugchr_text_decimal_glyph;
