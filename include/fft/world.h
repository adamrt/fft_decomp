...
struct card_save_header;

struct event_walk_to_parameters;

struct party_data;

struct world_formation_unit;
...
extern u8 g_world_editor_numeric_state_a[];
extern u8 g_world_editor_numeric_state_b[];
...
extern u8 g_world_menu_entry_item_icon_source[];
...
extern s32 world_item_get_half_price(s32 item_id);
...
extern void world_menu_init_palette_and_text(s32 unused);
extern void world_menu_init_primitive_colors_palette_bank_0(world_menu_palette_primitives_t*);
extern void world_menu_init_primitive_colors_palette_bank_1(world_menu_palette_primitives_t*);
...
extern void world_menu_set_brightness(s32 red, s32 green, s32 blue);
...
extern s32 world_script_get_variable(s32 variable_id);
...
extern s32 world_shop_adjust_poached_item_quantity(s32 item_id, s32 delta);
