 ...
 * (thread[4]) or the global event mode. The palette initializer receives
 * `primitives` unchanged in $a0. */
void attack_gfx_apply_menu_palette_for_mode(s32 primitives, s32* thread) {
