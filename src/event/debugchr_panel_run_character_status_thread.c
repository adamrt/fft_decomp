...
void debugchr_panel_run_character_status_thread(void) {
    ...
    screen = g_debugchr_panel_frames_a;
    base = g_debugchr_panel_frames_a;
    state = (battle_menu_status_panel_slot_state_t*)g_debugchr_editor_unit_fields;
    rect = FRAME_RECT;
    battle_menu_init_numeric_display_frame_primitives((RECT*)rect, &screen->numeric_frame);
    debugchr_gfx_init_menu_tile_and_line_primitives((battle_menu_status_panel_menu_primitives_t*)screen);
    ...
    for (;;) {
        ...
        debugchr_panel_set_primitive_colors((battle_menu_status_panel_primitives_t*)screen, thread);
