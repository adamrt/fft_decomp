...
void debugchr_panel_run_character_status_thread(void) {
    ...
    for (;;) {
        ...
        if (frame == 0 || thread->redraw_request == 1) {
            ...
            LoadImage(&g_debugchr_panel_text_upload_rect_a, (u32*)g_debugchr_panel_text_image_a);
            ...
            LoadImage(&g_debugchr_panel_text_upload_rect_b, (u32*)g_debugchr_panel_text_image_b);
