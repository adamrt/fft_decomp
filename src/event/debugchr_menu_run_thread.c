 ...
 * closes. The DEBUGCHR twin of world_menu_icon_list_thread. */
void debugchr_menu_run_thread(void) {
    RECT rect;
    ...
    *redraw = 1;
    for (i = 0;; i++) {
        ...
        if (battle_menu_should_close_thread(g_debugchr_input_controller) != 0) {
            break;
        }
