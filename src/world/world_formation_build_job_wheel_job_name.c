...
void world_formation_build_job_wheel_job_name(void) {
    ...
    destination_rect[0] = 0x24C;
    destination_rect[1] = 0x130;
    destination_rect[2] = 0x14;
    destination_rect[3] = 0x10;
    world_text_render_id_list_to_image_rows(font, (s16*)name, (RECT*)destination_rect, 0);
