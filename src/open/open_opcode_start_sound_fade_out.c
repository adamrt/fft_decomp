...
/* Starts the sound fade-out for command[1] and advances past the command.
 *
 ...
 * prologue's ra save. */
void open_opcode_start_sound_fade_out(s16* command) {
    open_sound_set_type_and_volume(0, command[1] * 4);
