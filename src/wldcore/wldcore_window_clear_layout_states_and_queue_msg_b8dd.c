 ...
 * queues message 0xB8DD on thread 14.
 *
 ...
 * The sibling at 0x800897b0 publishes the same fields without the queue. */
void wldcore_window_clear_layout_states_and_queue_msg_b8dd(s32* param) {
    s32 index;
    s32 second;
    s32 slot;
    s32 pad[2];
    ...
    world_thread_set_parameters(14, 0x19, 0xB8DD, 0);
}
