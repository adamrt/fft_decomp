...
void battle_map_append_mesh_geometry(u16* geometry_data, battle_map_mesh_part_metadata_t* metadata) {
    ...
    if (has_polygons) {
        ...
        destination_offset = index * 0x18;
        do {
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].x0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].y0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].z0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].x1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].y1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].z1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].x2);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].y2);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_triangle_normals[0].z2);
            index++;
            destination_offset += 0x18;
        } while (index < polygon_end_copy);
    }
    ...
    if (has_polygons) {
        destination_byte_end <<= 5;
        do {
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].x0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].y0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].z0);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].x1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].y1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].z1);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].x2);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].y2);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].z2);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].x3);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].y3);
            COPY_GEOMETRY_HALFWORD(g_battle_map_textured_quad_normals[0].z3);
            destination_offset += 0x20;
        } while (destination_offset < destination_byte_end);
    }
