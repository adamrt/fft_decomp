...
typedef struct battle_ability_list {
...
void battle_menu_build_ability_list(s32 mode) {
    ...
    g_battle_ability_menu_layout.text_ids[0] = (s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids;
    g_battle_ability_menu_layout.text_ids[1] = (s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values;
    g_battle_ability_menu_layout.text_ids[2] = (s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->extras;
    ...
    for (i = 0; i < 0x50; i++) {
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids[i] = 0xFFFF;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs[i] = 0xFF;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_23e[i] = 1;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values[i] = 0;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->extras[i] = 0xFFFF;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->flags[i] = 0;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2[i] = 1;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled[i] = 0xFF;
        g_battle_menu_ability_display_flags[i] = 0;
    }
    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs[0x50] = 0xFF;
    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_23e[0x50] = 0xFF;
    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->flags[0x50] = 0xFF;
    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2[0x50] = 0xFF;
    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled[0x50] = 0xFF;

    if (type == ACTION_MENU_TYPE_DEFAULT) {
        battle_menu_get_unit_skillset_ability_data(unit_index, skillset,
            (s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_23e, 0,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->flags,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2);
        battle_copy_bytes(((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_23e, 0x50);
    }
    if (type == ACTION_MENU_TYPE_ITEM_INVENTORY) {
        battle_menu_display_item_inventory_ability(
            unit_index, skillset, ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs);
    }
    ...
    if (type == ACTION_MENU_TYPE_ARITHMETICKS) {
        if (mode == 2) {
            battle_menu_load_math_skill_attributes(
                unit_index, skillset, ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids);
        }
        if (mode == 1) {
    ...
    if (type == ACTION_MENU_TYPE_MONSTER) {
        battle_menu_collect_monster_skill_abilities(unit_index, skillset,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids, 0,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->flags);
    }
    ...
    if (type == ACTION_MENU_TYPE_CHARGE) {
        battle_menu_load_charge_skillset(unit_index, skillset, ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2);
        battle_copy_bytes(((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs, 0x50);
    }
    window_x = 0xAC;
    if (type != ACTION_MENU_TYPE_ARITHMETICKS) {
        mode = 0;
    ...
    if (g_battle_menu_action_type_modes[type][1] == 1) { /* lists by id */
        ...
        count = ((s32 (*)(void*, u8*, s32))battle_menu_copy_ff_terminated_bytes_to_halfwords)(
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs, 0);
        battle_menu_widen_bytes_to_halfwords((s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->extras,
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2, count);
        found = 0;
        for (i = 0; i < count; i++) {
            ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values[i]
                = g_main_item_quantities[((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids[i]];
            if (((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values[i] == 0) {
        ...
        if (found != 0) {
            ...
            battle_menu_widen_bytes_to_halfwords((s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values,
                ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2, count);
            window_x = 0x94;
            row_mode = 8;
        }
        ...
        for (count = 0; count < 0x40; count++) {
            if (((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids[count] == 0xFFFF) {
                break;
            }
        }
        if (type == ACTION_MENU_TYPE_DEFAULT) {
            for (i = 0; i < count; i++) {
                if (((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs[i] != 0) {
                    found = 1;
                    break;
                }
            }
        ...
        if (type == ACTION_MENU_TYPE_ARITHMETICKS && mode > 0) {
            ...
            if (found != 0 && type == ACTION_MENU_TYPE_DEFAULT) {
                ...
                ((s32 (*)(void*, u8*, s32))battle_menu_copy_ff_terminated_bytes_to_halfwords)(
                    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values,
                    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs, count);
                window_x -= 8;
                battle_menu_widen_bytes_to_halfwords((s16*)((battle_ability_list_t*)g_battle_ai_workspace_ptr)->extras,
                    ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->bytes_2e2, count);
                row_mode = 6;
    ...
    for (i = 0; i < count; i++) {
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids[i] |= row_flags;
        if (type == ACTION_MENU_TYPE_DEFAULT) {
            if (unit->mp - ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->mp_costs[i] < 0
                && ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled[i] != 0) {
                g_battle_menu_ability_display_flags[i] = 8;
            }
        }
        if (type == ACTION_MENU_TYPE_DEFAULT || type == ACTION_MENU_TYPE_MONSTER) {
            if ((((battle_ability_list_t*)g_battle_ai_workspace_ptr)->flags[i] & 2)
                && ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->enabled[i] != 0
    ...
    if (count == 0) {
        ...
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->ids[0] = TEXT_ID_ABILITY_NAME_BASE;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->values[0] = 0;
        ((battle_ability_list_t*)g_battle_ai_workspace_ptr)->extras[0] = 0;
