...
typedef struct battle_bg_sound_fade_request {
    u8 sound_id;    /* 0x0 */
    u8 volume_from; /* 0x1 */
    u8 volume_to;   /* 0x2 */
    u8 unknown_03;  /* 0x3 */
    u8 steps;       /* 0x4 */
} battle_bg_sound_fade_request_t;

void battle_sound_edit_bg_thread(void) {
    battle_bg_sound_fade_request_t* request;
    s32 sound_id;
    s32 volume_from;
    s32 volume_to;
    s32 steps;
    ...
    step = 0;
    request = (battle_bg_sound_fade_request_t*)battle_thread_get_current_parameter_1();
