            ...
            if (++gradient_transition->tick >= repeat[0] >> 2) {
                ...
                if (++gradient_transition->phase >= 0x20) {
                    if (repeat[1] == 1) {
                        ...
                        battle_map_blend_background_gradient_color(9, repeat[0], gradient_transition->_unknown04[1],
                            gradient_transition->_unknown04[2], gradient_transition->_unknown04[3]);
                        repeat[1] = 1;
                    } else {
                        goto deactivate;
                    }
        ...
        if (g_battle_map_ambient_light_transition.period >= 4) {
            if (++g_battle_map_ambient_light_transition.tick >= g_battle_map_ambient_light_transition.period >> 2) {
                ...
                if (++g_battle_map_ambient_light_transition.phase >= 0x20) {
                    if (g_battle_map_ambient_light_transition._unknown04[0] == 1) {
                        battle_map_blend_ambient_light_color(8, g_battle_map_ambient_light_transition.period, 0, 0, 0);
                        g_battle_map_ambient_light_transition._unknown04[0] = 2;
                    } else if (g_battle_map_ambient_light_transition._unknown04[0] == 2) {
                        battle_map_blend_ambient_light_color(9, g_battle_map_ambient_light_transition.period,
                            g_battle_map_ambient_light_transition._unknown04[1],
                            g_battle_map_ambient_light_transition._unknown04[2],
                            g_battle_map_ambient_light_transition._unknown04[3]);
                        g_battle_map_ambient_light_transition._unknown04[0] = 1;
                    } else {
                        transition->active = 0;
                    }
                }
        ...
        if (g_battle_map_darkness_transition.period >= 4) {
            if (++g_battle_map_darkness_transition.tick >= g_battle_map_darkness_transition.period >> 2) {
                ...
                if (++g_battle_map_darkness_transition.phase >= 0x20) {
                    if (g_battle_map_darkness_transition._unknown04[0] == 1) {
                        battle_map_blend_darkness_color(8, g_battle_map_darkness_transition.period, 0, 0, 0);
                        g_battle_map_darkness_transition._unknown04[0] = 2;
                    } else if (g_battle_map_darkness_transition._unknown04[0] == 2) {
                        battle_map_blend_darkness_color(9, g_battle_map_darkness_transition.period,
                            g_battle_map_darkness_transition._unknown04[1],
                            g_battle_map_darkness_transition._unknown04[2],
                            g_battle_map_darkness_transition._unknown04[3]);
                        g_battle_map_darkness_transition._unknown04[0] = 1;
                    } else {
                        transition->active = 0;
                    }
                }
            ...
            if (g_battle_map_darkness_transition._unknown04[0] == 1) {
                ...
                battle_map_blend_darkness_color(9, g_battle_map_darkness_transition.period,
                    g_battle_map_darkness_transition._unknown04[1], g_battle_map_darkness_transition._unknown04[2],
                    g_battle_map_darkness_transition._unknown04[3]);
                g_battle_map_darkness_transition._unknown04[0] = 1;
            } else {
                transition->active = 0;
                ...
                if (g_battle_map_palette_state.banks[i].animations[row].mode >= 4) {
                    if (++g_battle_map_palette_state.banks[i].animations[row].delay_counter
                        ...
                        if (++g_battle_map_palette_state.banks[i].animations[row].blend_step >= 0x20) {
                            if (g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] == 1) {
                                battle_map_modify_palette(
                                    8, g_battle_map_palette_state.banks[i].animations[row].mode, i, row, 0, 0, 0, 0);
                                g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] = 2;
                            } else if (g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] == 2) {
                                battle_map_modify_palette(9, g_battle_map_palette_state.banks[i].animations[row].mode,
                                    i, row, 0, g_battle_map_palette_state.banks[i].animations[row]._unknown04[1],
                                    g_battle_map_palette_state.banks[i].animations[row]._unknown04[2],
                                    g_battle_map_palette_state.banks[i].animations[row]._unknown04[3]);
                                g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] = 1;
                            } else {
                    ...
                    if (++g_battle_map_palette_state.banks[i].animations[row].blend_step >= 8) {
                        if (g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] == 1) {
                            ...
                            battle_map_modify_palette(9, g_battle_map_palette_state.banks[i].animations[row].mode, i,
                                row, 0, g_battle_map_palette_state.banks[i].animations[row]._unknown04[1],
                                g_battle_map_palette_state.banks[i].animations[row]._unknown04[2],
                                g_battle_map_palette_state.banks[i].animations[row]._unknown04[3]);
                            g_battle_map_palette_state.banks[i].animations[row]._unknown04[0] = 1;
                        } else {
            ...
            if (g_battle_map_palette_state.banks[i].animations[0].mode >= 4) {
                if (++g_battle_map_palette_state.banks[i].animations[0].delay_counter
                    ...
                    if (++g_battle_map_palette_state.banks[i].animations[0].blend_step >= 0x20) {
                        if (g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] == 1) {
                            battle_map_modify_palette(
                                8, g_battle_map_palette_state.banks[i].animations[0].mode, i, 0, 1, 0, 0, 0);
                            g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] = 2;
                        } else if (g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] == 2) {
                            battle_map_modify_palette(9, g_battle_map_palette_state.banks[i].animations[0].mode, i, 0,
                                1, g_battle_map_palette_state.banks[i].animations[0]._unknown04[1],
                                g_battle_map_palette_state.banks[i].animations[0]._unknown04[2],
                                g_battle_map_palette_state.banks[i].animations[0]._unknown04[3]);
                            g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] = 1;
                        } else {
                            for (j = 15; j >= 0; j--) {
                ...
                if (++g_battle_map_palette_state.banks[i].animations[0].blend_step >= 8) {
                    if (g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] == 1) {
                        ...
                        battle_map_modify_palette(9, g_battle_map_palette_state.banks[i].animations[0].mode, i, 0, 1,
                            g_battle_map_palette_state.banks[i].animations[0]._unknown04[1],
                            g_battle_map_palette_state.banks[i].animations[0]._unknown04[2],
                            g_battle_map_palette_state.banks[i].animations[0]._unknown04[3]);
                        g_battle_map_palette_state.banks[i].animations[0]._unknown04[0] = 1;
                    } else {
