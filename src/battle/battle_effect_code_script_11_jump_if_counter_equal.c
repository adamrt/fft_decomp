 ...
 * top two bits of the second byte equals the second halfword; otherwise step
 * over the 6-byte instruction. */
s32 battle_effect_code_script_11_jump_if_counter_equal(effect_record_t* effect) {
    s16 pc = effect->pc;
