...
void battle_map_blend_ambient_light_color(s32 mode, s32 frame_duration, s32 red, s32 green, s32 blue) {
    ...
    if (frame_duration != 0) {
        ...
        if (mode == 9) {
            ...
            g_battle_map_ambient_light_transition._unknown04[1] = red;
            g_battle_map_ambient_light_transition._unknown04[2] = green;
            g_battle_map_ambient_light_transition._unknown04[3] = blue;
        }
    } else {
