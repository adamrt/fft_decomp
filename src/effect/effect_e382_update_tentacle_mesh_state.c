...
s32 effect_e382_update_tentacle_mesh_state(s16 record_index, s32 byte_offset, s32 geometry_index, s32 frame) {
    SVECTOR tip;
    SVECTOR tip_spread;
    VECTOR origin;
    VECTOR spread;
    ...
    case EFFECT_PHASE_UPDATE:
        ...
        for (j = 0; j < 8; j++) {
            ...
            scratch = g_effect_tentacle_mesh_brightness_table[brightness_row][shade_index];
            shade_index--;
