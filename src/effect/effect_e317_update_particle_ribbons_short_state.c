...
s32 effect_e317_update_particle_ribbons_short_state(s16 record_index, s32 byte_offset, s32 geometry_index, s32 frame) {
    SVECTOR target_base;
    ...
    case EFFECT_PHASE_UPDATE:
        ...
        for (k = 0; k < RIBBON_SLOTS; k++) {
            ...
            quad->v0 = v;
            quad->v2 = v + height;
            factor = g_effect_e317_particle_ribbon_short_brightness_table[row][point];
