 ...
 * brightness from g_effect_e015_ring_mesh_brightness_table. The quads are double-buffered in the work block.
 *
...
s32 effect_e015_update_ring_mesh_state(s32 record_index, s32 byte_offset, s32 geometry_index, s32 frame) {
    ...
    case EFFECT_PHASE_UPDATE:
        ...
        k = g_effect_e015_ring_mesh_brightness_table[n][0];
        ...
        k = g_effect_e015_ring_mesh_brightness_table[n][1];
        ...
        k = g_effect_e015_ring_mesh_brightness_table[n][2];
        for (i = 0; i < RING_MESH_SEGMENTS; i++) {
