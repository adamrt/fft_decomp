 ...
 * target. */
s32 effect_e004_update_polar_mesh_state(s16 record_index, s32 byte_offset, s32 geometry_index, s32 frame) {
    ...
    case EFFECT_PHASE_UPDATE:
        ...
        for (i = 0; i < 4; i++) {
            ...
            brightness = g_effect_e004_polar_mesh_brightness_table[scratch->brightness_row][0];
        ...
        for (j = 0; j < 4; j++) {
            ...
            for (i = 0; i < 4; i++) {
                ...
                brightness = g_effect_e004_polar_mesh_brightness_table[scratch->brightness_row][j + 1];
        ...
        for (i = 0; i < 4; i++) {
            ...
            brightness = g_effect_e004_polar_mesh_brightness_table[scratch->brightness_row][5];
